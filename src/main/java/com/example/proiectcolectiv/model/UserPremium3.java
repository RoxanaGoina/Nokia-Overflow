...
public class UserPremium3 {
    ...
    public UserPremium3(String uid, String photoURL, String displayName, UserPremium.Stats stats, Map<String, List<String>> badges, List<Question> questions, List<Question> favorites, List<String> interests) {
        this.uid = uid;
